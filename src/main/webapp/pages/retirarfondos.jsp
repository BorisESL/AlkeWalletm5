                    ...
                    <div>
                        ...
                        <form>
                            <div class="form-group m-md-4">
                                <label class="m-md-3 text-md-center p-2" for="depositAmount">Monto a Retirar:</label>
                                <input type="number" class="form-control text-center" id="depositAmount"
                                    placeholder="Ingrese Monto">
                            </div>
                            <div class="d-flex justify-content-center">
                                <button type="submit" class="btn btn-dark text-warning mt-3 mx-2">Realizar
                                    Retiro</button>
