            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-link active text-dark fw-bold" aria-current="page" href="menuprincipal.jsp">Menú
                            principal</a>
                        ...
                        <a class="nav-link active text-dark fw-bold" aria-current="page" href="ultimosmov.html">Últimos
                            movimientos</a>
  ...
  <main class="container mt-5">
    <div class="formulario2 d-flex flex-column justify-content-center text-white">
      ...
      <div class="form-group text-center">
        ...
        <h2 class="text-md-center text-black">$<span id="accountBalance">0</span></h2>
      </div>
      <div class="row">
        <div class="col-12 mb-3">
          <a href="deposito.html" class="btn btn-dark text-warning w-100">Depósito</a>
        </div>
      </div>
    </div>
  </main>
